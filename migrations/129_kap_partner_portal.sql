-- KitPlatform 129: KAP Partner Portal — CTV/consultant accounts, referral attribution, lead pipeline
-- Depends on: 068
-- NOTE: Formerly drafted as 103_kap_partner_portal.sql but 103 is taken by
-- 103_healthcare_network_foundation.sql in the prod manifest. Do not renumber back to 103.
...
-- App role (kitplatform) must read partners for KAP admin lead list JOIN.
DO $$
BEGIN
