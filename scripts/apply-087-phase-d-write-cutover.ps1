# Apply migration 087 — Phase D write cutover extension tables
param(
...
$Migration = Join-Path $Root "migrations\087_phase_d_write_cutover.sql"
...
Write-Host ">> 087_phase_d_write_cutover.sql" -ForegroundColor Yellow
