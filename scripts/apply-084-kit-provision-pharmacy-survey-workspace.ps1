# Apply migration 084 — provision pharmacy_survey workspace
param(
...
$Migration = Join-Path $Root "migrations\084_kit_provision_pharmacy_survey_workspace.sql"
...
Write-Host ">> 084_kit_provision_pharmacy_survey_workspace.sql" -ForegroundColor Yellow
