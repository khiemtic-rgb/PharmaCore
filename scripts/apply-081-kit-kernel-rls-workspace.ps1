# Apply migration 081 — kernel RLS + workspace backfill on dual-write tables
param(
...
$Migration = Join-Path $Root "migrations\081_kit_kernel_rls_workspace.sql"
...
Write-Host ">> 081_kit_kernel_rls_workspace.sql" -ForegroundColor Yellow
