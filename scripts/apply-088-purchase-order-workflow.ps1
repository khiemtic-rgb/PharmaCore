# Apply migration 088 — PO approval workflow seed
param(
...
$Migration = Join-Path $Root "migrations\088_purchase_order_workflow.sql"
...
Write-Host ">> 088_purchase_order_workflow.sql" -ForegroundColor Yellow
