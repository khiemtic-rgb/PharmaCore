# Apply migration 082 — pack_pharmacy schema (strangler views + extension table)
param(
...
$Migration = Join-Path $Root "migrations\082_pack_pharmacy_schema.sql"
...
Write-Host ">> 082_pack_pharmacy_schema.sql" -ForegroundColor Yellow
