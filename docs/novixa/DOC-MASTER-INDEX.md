...
| **DOC-005** | Product Guideline | Kiến trúc sản phẩm, naming | ⭐⭐⭐⭐⭐ | [product-overview-v1.md](./02-product/product-overview-v1.md) (NVX-PRD-01) · [module-catalog-v1.md](./02-product/module-catalog-v1.md) (NVX-PRD-02) · [pharmacy-success-capability-map-v1.md](./02-product/pharmacy-success-capability-map-v1.md) (NVX-PRD-03) · `PHASE_SCOPE.md` · neo [KIT-BP-ASBUILT](./03-solution/kitplatform-enterprise-blueprint-asbuilt-v2.1.md) | ✅ Draft — **bắt buộc gắn nhãn Phase** |
